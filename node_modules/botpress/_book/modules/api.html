...
<html lang="" >
    <head>
        ...
        <title>Exposing an API · Botpress Official Documentation</title>
...
<ul class="summary">
        ...
        <li class="chapter " data-level="8.1.1" data-path="events.html">
        ...
        <li class="chapter active" data-level="8.1.2" data-path="api.html">
...
<div id="book-search-results">
    <div class="search-noresults">
                                ...
                                <h1 id="making-your-module-expose-an-api"><a name="making-your-module-expose-an-api" class="plugin-anchor" href="#making-your-module-expose-an-api"><i class="fa fa-link" aria-hidden="true"></i></a>Making your module expose an API</h1>
<h2 id="built-in-http-server"><a name="built-in-http-server" class="plugin-anchor" href="#built-in-http-server"><i class="fa fa-link" aria-hidden="true"></i></a>Built-in HTTP Server</h2>
<p>Botpress uses and exposes an instance of <a href="http://expressjs.com/" target="_blank"><code>express</code></a>. The web interface is served by Express as well as the built-in botpress API.</p>
<p>You may define your own APIs with the help of Routers (<code>express.Router</code>). From the official express <a href="http://expressjs.com/en/guide/routing.html" target="_blank">documentation</a>:</p>
<blockquote>
...
<p>To get a Router, simply call the <a href="core-reference.md"><code>getRouter(moduleName)</code></a> method. The name of the module is required as API routes are scoped by modules.</p>
<h3 id="api-example"><a name="api-example" class="plugin-anchor" href="#api-example"><i class="fa fa-link" aria-hidden="true"></i></a>API Example</h3>
<pre><code class="lang-js"><span class="hljs-keyword">var</span> router = bp.getRouter(<span class="hljs-string">&apos;botpress-analytics&apos;</span>);

<span class="hljs-comment">// Will be exposed at: http://localhost:3000/api/botpress-analytics/ping</span>
router.get(<span class="hljs-string">&apos;/ping&apos;</span>, (req, res, next) =&gt; res.send(<span class="hljs-string">&apos;pong&apos;</span>))
</code></pre>
<h3 id="authentication"><a name="authentication" class="plugin-anchor" href="#authentication"><i class="fa fa-link" aria-hidden="true"></i></a>Authentication</h3>
<p>By default, routes will be secured the same way the regular botpress API routes are secured. In some instances, you might want to disable the build-in botpress authentication, which you need to specify when you get the router:</p>
<pre><code class="lang-js">bp.getRouter(<span class="hljs-string">&apos;botpress-messenger&apos;</span>, { auth: <span class="hljs-literal">false</span> })
</code></pre>
<p>You can also conditionally disable authentication:</p>
<pre><code class="lang-js">bp.getRouter(<span class="hljs-string">&apos;botpress-messenger&apos;</span>, {
    auth: (req) =&gt; req.method.toLowerCase() === <span class="hljs-string">&apos;post&apos;</span>
}
</code></pre>
